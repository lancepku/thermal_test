...
do i = 1, nphase 
    ...
    print *, i
    write(6,533) irheol(i),visc(i),den(i),alfa(i),beta(i),pln(i),acoef(i),eactiv(i),rl(i),rm(i), &
        plstrain1(i),plstrain2(i),plstrain3(i),fric1(i),fric2(i),fric3(i),cohesion1(i), &
        cohesion2(i),cohesion3(i), dilat1(i),dilat2(i),dilat3(i), &
        conduct(i),cp(i),ts(i),tl(i),tk(i),fk(i)
end do
533 format(1i3,27e10.2)
...
call AdvanceToNextInputLine( 4 )
read(4,*) ny_inject, nelem_inject, rate_inject, extrusion_amount 
...
call ReadHeatinject   !see user_Liu.f90
return
end
